...
export const DEFAULT_ACCOUNTS = [
  ...
  { code: '1360', name: 'Withholding Tax Receivable - At Source', type: 'asset', description: 'Creditable withholding tax withheld by clients/payors from payments received — a tax credit against income tax due' },
